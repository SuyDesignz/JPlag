...
class javaEndToEndTestCases {
     ...
     * @param testIdentifier name of the testIdentifier to load and identify the stored results
    ...
    void normalizationLevelTest(String[] testClassNames, int testIdentifier) throws IOException, ExitException {
        ...
        jplagTestSuiteHelper.saveTemporaryTestResultModelToJson(jplagResult, testIdentifier);
